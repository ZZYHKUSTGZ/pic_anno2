...
if __name__ == "__main__":
    # 假设原始 JSON 路径
    json_file = "/data_sdg/sunz/FragFake/finished_file/dataset/ADE20K/GoT/easy/result/GoT_ADE20K_qwen2vl_easy.json"
    # 输出更新后 JSON 的路径
    output_json_file = "zzy_anno_GoT_ADE20K_qwen2vl_easy.json"
    # 搬运图片的目标根目录
