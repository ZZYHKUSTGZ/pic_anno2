...
if __name__ == "__main__":
    # 假设原始 JSON 路径
    json_file = "/fdata/FragFake/finished_file/dataset/ffhq_face_change/result/ffhq_face_cchange_ADE20K_qwen2_easy.json"
    # 输出更新后 JSON 的路径
    output_json_file = "zzy_anno_ffhq_face_cchange_ADE20K_qwen2_easy.json"
    # 搬运图片的目标根目录
