...
if __name__ == "__main__":
    # 假设原始 JSON 路径
    json_file = "/fdata/FragFake/finished_file/dataset/ADE20K/magic_brush/easy/result/magic_brush_ADE20K_qwen2_5_vl_step1xedit_easy.json"
    # 输出更新后 JSON 的路径
    output_json_file = "zzy_anno_magic_brush_ADE20K_qwen2_5_vl_step1xedit_easy.json"
    # 搬运图片的目标根目录
