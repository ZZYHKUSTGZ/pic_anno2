...
if __name__ == "__main__":
    # 假设原始 JSON 路径
    json_file = "/data_sdg/sunz/FragFake/finished_file/dataset/ADE20K/UltraEdit/hard/result/UltraEdit_ADE20K_qwen2vl_hard.json"
    # 输出更新后 JSON 的路径
    output_json_file = "zzy_anno_UltraEdit_ADE20K_qwen2vl_hard.json"
    # 搬运图片的目标根目录
